                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-lg-3 col-xl-2 ms-auto align-self-center">
                                    <div class="read-more text-lg-end">
                                        <a href="service-details" wire:navigate class="common-btn uppercase border-btn">read More
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 ms-auto">
                        <div class="faq-image">
                            <div class="image-one">
                                <img src="/img/faqs/faq-image-one.png" alt="faq-image-one">
                            </div>
                            <div class="image-two">
                                <img src="/img/faqs/faq-image-two.png" alt="faq-image-two"
                                    class="img-fluid w-100">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="testimonial-item-one">
                            <div class="quote-icon">
                                <img src="/img/icons/quote.png" alt="quote">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="image pe-3">
                                    <img src="/img/messages/messages-image.png" alt="messages-image"
                                        class="img-fluid w-100">
                                </div>
                            </div>
                            <div class="col-lg-6 align-self-center">
                    ...
                    <div class="row news-area-one-slider">
                        <div class="col-lg-4">
                            <div class="news-item-one">
                                <div class="image">
                                    <a href="blog-details" wire:navigate class="d-block w-100">
                                        <img src="/img/news/news-1.png" alt="news-1" class="img-fluid w-100">
                                    </a>
                                </div>
                                <div class="text">
                                    <div class="news-meta">
                            ...
                            <div class="news-item-one">
                                <div class="image">
                                    <a href="#" class="d-block w-100">
                                        <img src="/img/news/news-2.png" alt="news-2" class="img-fluid w-100">
                                    </a>
                                </div>
                                <div class="text">
                                    <div class="news-meta">
                        ...
                        <div class="col-lg-4">
                            <div class="news-item-one">
                                <div class="image">
                                    <a href="blog-details" wire:navigate class="d-block w-100">
                                        <img src="/img/news/news-3.png" alt="news-3" class="img-fluid w-100">
                                    </a>
                                </div>
                                <div class="text">
                                    <div class="news-meta">
